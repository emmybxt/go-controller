...
import (
	...
	fiberadapter "github.com/emmybxt/go-controller/v2/adapters/fiber-v2"
	"github.com/gofiber/fiber/v2"
)

func setupFiberV2(t *testing.T) harness {
	t.Helper()
...
func TestFiberV2AfterRunsOnceWithExplicitNext(t *testing.T) {
	h := setupFiberV2(t)
	handler := func(c *fiber.Ctx) error {
